		...
		if ( EPKB_Icons::is_theme_with_image_icons( $kb_config ) || $image_found ) { // || EPKB_KB_Wizard::get_demo_icons_type($kb_config['id']) == 'image' ) {
			...
			$category_icons = array(
				11 => array(
					'type' => 'image',
					'image_id' => 0,
					'image_thumbnail_url' => Echo_Knowledge_Base::$plugin_url . 'img/demo-icons/women-icon.png',
					'name' => 'ep_font_icon_person',
				),     // Account
				22 => array(
					'type' => 'image',
					'image_id' => 0,
					'image_thumbnail_url' => Echo_Knowledge_Base::$plugin_url . 'img/demo-icons/e-commerce-icon.png',
					'name' => 'ep_font_icon_shopping_cart',
				),// Ordering
				33 => array(
					'type' => 'image',
					'image_id' => 0,
					'image_thumbnail_url' => Echo_Knowledge_Base::$plugin_url . 'img/demo-icons/payment-icon.png',
					'name' => 'ep_font_icon_credit_card',
				), // Payment
				44 => array(
					'type' => 'image',
					'image_id' => 0,
					'image_thumbnail_url' => Echo_Knowledge_Base::$plugin_url . 'img/demo-icons/earth-icon.png',
					'name' => 'epkbfa-truck',
				),       // Shipping
				55 => array(
					'type' => 'image',
					'image_id' => 0,
					'image_thumbnail_url' => Echo_Knowledge_Base::$plugin_url . 'img/demo-icons/info-icon.png',
					'name' => 'epkbfa-bookmark',
				),     // Returns & Refunds
				66 => array(
					'type' => 'image',
					'image_id' => 0,
					'image_thumbnail_url' => Echo_Knowledge_Base::$plugin_url . 'img/demo-icons/price-tag-icon.png',
