...
class EPKB_Config_Menu {
	...
	private function display_page( $kb_config ) {        ?>
		...
		<h1 style="color: red; line-height: 1.2em; background-color: #eaeaea; border: solid 1px #ddd; padding: 20px;" class="epkb-css-working-hide-message">The CSS for this KB admin page is missing. This is most likely due to one of your plugins blocking our CSS.
			Try to deactivate your plugins or contact us for help..</h1>
