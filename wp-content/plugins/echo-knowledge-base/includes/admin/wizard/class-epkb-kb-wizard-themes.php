...
class EPKB_KB_Wizard_Themes {
	...
	public static function get_theme( $theme_id, $kb_config ) {
        ...
        $new_config['breadcrumb_enable'] = $kb_config['breadcrumb_enable'];
        $new_config['article_content_enable_back_navigation'] = $kb_config['article_content_enable_back_navigation'];
		$new_config['id'] = $kb_config['id'];
	...
	public static $themes = array(
		...
		'theme_elegant' => array(
			...
			// Search
			'search_title_font_color'               => '#FFFFFF',
			'search_background_color'               => '#c9418e',
			'search_text_input_background_color'    => '#FFFFFF',
			'search_text_input_border_color'        => '#CCCCCC',
			'search_btn_background_color'           => '#40474f',
			'search_btn_border_color'               => '#F1F1F1',
            ...
            'search_box_hint'                           =>'Search the documentation...',
            'search_button_name'                        =>'Search',
            'search_results_msg'                        =>'Search Results for',
	        ...
	        'section_head_category_icon_size'           => '57',
	        'section_divider'                           => 'on',
            ...
            'section_border_color'                      => '#f7f7f7',
            'section_head_font_color'                   => '#40474f',
            'section_head_background_color'             => '#f9f9f9',
            'section_head_description_font_color'       => '#b3b3b3',
            'section_divider_color'                     => '#edf2f6',
            'section_category_font_color'               => '#40474f',
            'section_category_icon_color'               => '#ca428f',
            'section_head_category_icon_color'          => '#ca428f',
			...
			'article_search_box_input_width'			        => '50',
			'article_search_title_font_color'			        => '#000000',
			'article_search_text_input_border_color'			=> '#CCCCCC',
			'article_search_btn_background_color'			    => '#1168bf',
			'article_search_btn_border_color'			        => '#F1F1F1',
		...
		'theme_modern' => array(
			...
			'article_search_box_input_width'                => '50',
			'article_search_title'			                => 'Have a Question?',
			'article_search_title_font_size'			    => 40,
			'article_search_title_font_color'               => '#40474f',
			'article_search_background_color'			    => '#FFFFFF',
			'article_search_text_input_border_color'        => '#40474f',
			'article_search_btn_background_color'			=> '#40474f',
			'article_search_btn_border_color'			    => '#40474f',
			'article_search_input_border_width'             => 3,
		...
		'theme_image' => array(
			...
			'article_search_box_input_width'            => '50',
			'article_search_title_font_color'           => '#ffffff',
			'article_search_background_color'	        => '#B1D5E1',
			'article_search_text_input_border_color'    => '#CCCCCC',
			'article_search_btn_background_color'	    => '#686868',
			'article_search_btn_border_color'		    => '#F1F1F1',
			'article_search_title_font_size'		    => 40,
		...
		'theme_informative' => array(
			...
			'article_search_box_input_width'                => '50',
			'article_search_title_font_color'               => '#ffffff',
			'article_search_background_color'			    => '#904e95',
			'article_search_text_input_border_color'        => '#CCCCCC',
			'article_search_btn_background_color'			=> '#686868',
			'article_search_btn_border_color'			    => '#F1F1F1',
			'article_search_title_font_size'			    => 40,
		...
		'theme_formal' => array(
			...
			'search_box_padding_bottom'			    => '50',
			'article_search_box_input_width'                => '50',
			'article_search_title'			                => 'Welcome to our Knowledge Base',
			'article_search_title_font_size'			    => 40,
			'article_search_title_font_color'               => '#000000',
			'article_search_background_color'			    => '#edf2f6',
			'article_search_text_input_border_color'        => '#d1d1d1',
			'article_search_btn_background_color'			=> '#666666',
			'article_search_btn_border_color'			    => '#666666',
			'article_search_input_border_width'             => 1,
			'article_search_box_padding_top'			    => '50',
			'article_search_box_padding_bottom'			    => '50',
		...
		'theme_bright' => array(
			...
			'search_input_border_width'             => 3,
			'article_search_box_input_width'                => '50',
			'article_search_title'			                => 'What are you looking for?',
			'article_search_title_font_size'			    => 40,
			'article_search_title_font_color'               => '#f4c60c',
			'article_search_background_color'			    => '#FFFFFF',
			'article_search_text_input_border_color'        => '#f4c60c',
			'article_search_btn_background_color'			=> '#f4c60c',
			'article_search_btn_border_color'			    => '#f4c60c',
			'article_search_input_border_width'             => 3,
		...
		'theme_disctinct' => array(
			...
			'article_search_box_input_width'                => '50',
			'article_search_title'			                => 'Self Help Documentation',
			'article_search_title_font_size'			    => 40,
			'article_search_title_font_color'               => '#528ffe',
			'article_search_background_color'			    => '#f4f8ff',
			'article_search_text_input_border_color'        => '#bf25ff',
			'article_search_btn_background_color'			=> '#bf25ff',
			'article_search_btn_border_color'			    => '#bf25ff',
			'article_search_input_border_width'             => 1,
			'article_search_box_padding_top'                => 30,
			'article_search_box_padding_bottom'             => 30,
		...
		'theme_faqs' => array(
			...
			'article_search_box_input_width'                => '50',
			'article_search_title'			                => 'Support Center',
			'article_search_title_font_size'			    => 40,
			'article_search_title_font_color'               => '#ffffff',
			'article_search_background_color'			    => '#37de89',
			'article_search_text_input_border_color'        => '#37de89',
			'article_search_btn_background_color'			=> '#666666',
			'article_search_btn_border_color'			    => '#666666',
			'article_search_input_border_width'             => 1,
			'article_search_box_padding_top'                => 30,
		...
		'theme_organized' => array(
			...
			'article_search_title'			                    => 'Have a Question?',
			'article_search_title_font_color'                   => '#ffffff',
			'article_search_background_color'			        => '#8c1515',
			'article_search_text_input_border_color'			=> '#000000',
			'article_search_btn_background_color'			    => '#878787',
			'article_search_btn_border_color'			        => '#000000',
		...
		'theme_organized_2' => array(
	        ...
	        'templates_for_kb_padding_bottom'           =>'50',
	        'templates_for_kb_padding_left'             =>'4',
	        'templates_for_kb_padding_right'            =>'4',
	        'templates_for_kb_margin_top'               =>0,
	        'templates_for_kb_margin_bottom'            =>'50',
	        'templates_for_kb_margin_left'              =>'4',
	        'templates_for_kb_margin_right'             =>'4',
	        ...
	        'search_title_font_color'                   =>'#e69e4a',
	        'search_background_color'                   =>'#43596e',
	        'search_text_input_background_color'        =>'#FFFFFF',
	        'search_text_input_border_color'            =>'#CCCCCC',
	        'search_btn_background_color'               =>'#40474f',
	        'search_btn_border_color'                   =>'#F1F1F1',
	        ...
	        'section_border_color'                      =>'#f7f7f7',
	        'section_head_font_color'                   =>'#40474f',
	        'section_head_background_color'             =>'#b1d5e1',
	        'section_head_description_font_color'       =>'#b3b3b3',
	        'section_divider_color'                     =>'#edf2f6',
	        'section_category_font_color'               =>'#40474f',
	        'section_category_icon_color'               =>'#ca428f',
	        ...
	        'search_button_name'                        =>'Search',
	        'search_results_msg'                        =>'Search Results for',
	        'tab_font_size'                             =>'tab_medium_font',
	        'tab_down_pointer'                          =>'on',
	        'tab_nav_active_font_color'                 =>'#e69e4a',
	        'tab_nav_active_background_color'           =>'#43596e',
	        'tab_nav_font_color'                        =>'#e69e4a',
			...
			'article_search_input_border_width'			    => '5',
			'article_search_box_padding_top'			    => '50',
			'article_search_box_padding_bottom'			    => '50',
			'article_search_background_color'			    => '#00b4b3',
			'article_search_text_input_border_color'		=> '#00c6c6',
			'article_search_btn_background_color'			=> '#686868',
			'article_search_btn_border_color'			    => '#F1F1F1',
			'article_search_title'			                => 'Help Center',
		...
		'theme_products_style' => array(
			...
			'search_box_padding_bottom'			    => '50',
			'search_box_input_width'			                => '50',
			'article_search_background_color'               => '#6e6767',
			'article_search_text_input_border_color'        => '#000000',
			'article_search_title'			                => 'Help Center',
			'article_search_btn_background_color'			=> '#686868',
			'article_search_btn_border_color'			    => '#F1F1F1',
		...
		'theme_tabs_clean_style' => array(
			...
			'search_box_padding_bottom'			    => '50',
			'search_title'			                => 'Help Center',
			'article_search_background_color'               => '#f2f2f2',
			'article_search_text_input_border_color'        => '#000000',
			'article_search_input_border_width'             => '1',
			'article_search_title_font_color'               => '#000000',
			'article_search_btn_border_color'               => '#000000',
			'article_search_btn_background_color'           => '#000000',
			'article_search_box_input_width'			                => '50',
		...
		'standard_2' => array(
			...
			'search_title'			                    => 'Have a Question?',
			'article_search_title_font_color'               =>  '#FFFFFF',
			'article_search_background_color'               =>  '#2991a3',
			'article_search_text_input_background_color'    =>  '#FFFFFF',
			'article_search_text_input_border_color'        =>  '#CCCCCC',
			'article_search_btn_background_color'           =>  '#40474f',
			'article_search_btn_border_color'               =>  '#F1F1F1',
			...
			'width'			                            => 'epkb-boxed',
			'section_font_size'			                => 'section_small_font',
			'expand_articles_icon'			            => 'ep_font_icon_folder_add',
			'section_head_alignment'			        => 'left',
			'section_head_category_icon_location'		=> 'left',
			'section_head_category_icon'			    => 'ep_font_icon_pencil', // DEPRECATED: category icons
			'section_divider'			                => 'on',
		...
		'standard_3' => array(
			...
			'search_box_padding_bottom'			        => '50',
			'search_title'			                    => 'Have a Question?',
			'article_search_title_font_color'               =>  '#fcfcfc',
			'article_search_background_color'               =>  '#fcfcfc',
			'article_search_text_input_background_color'    =>  '#FFFFFF',
			'article_search_text_input_border_color'        =>  '#0bcad9',
			'article_search_btn_background_color'           =>  '#f4c60c',
			'article_search_btn_border_color'               =>  '#0bcad9',
			'article_search_box_input_width'			        => '50',
			'article_search_box_padding_top'			        => '50',
			'article_search_box_padding_bottom'			        => '50',
			'article_search_title'			                    => 'Have a Question?',
		...
		'business' => array(
			...
			'search_title'			                    => 'Have a Question?',
			'article_search_title_font_color'               =>  '#000000',
			'article_search_background_color'               =>  '#fbfbfb',
			'article_search_text_input_background_color'    =>  '#FFFFFF',
			'article_search_text_input_border_color'        =>  '#CCCCCC',
			'article_search_btn_background_color'           =>  '#40474f',
			'article_search_btn_border_color'               =>  '#F1F1F1',
			'article_search_box_input_width'			    => '50',
			'article_search_box_padding_top'			    => '50',
			'article_search_box_padding_bottom'			    => '90',
			'article_search_box_margin_bottom'			    => '0',
			'article_search_title'			                    => 'Have a Question?',
		...
		'business_2' => array(
			...
			'search_box_margin_bottom'			    => '0',
			'search_title'			                    => 'Have a Question?',
			'article_search_title_font_color'               =>  '#6fb24c',
			'article_search_background_color'               =>  '#fbfbfb',
			'article_search_text_input_background_color'    =>  '#FFFFFF',
			'article_search_text_input_border_color'        =>  '#6fb24c',
			'article_search_btn_background_color'           =>  '#6fb24c',
			'article_search_btn_border_color'               =>  '#6fb24c',
			'article_search_box_input_width'			    => '50',
			'article_search_box_padding_top'			    => '50',
			'article_search_box_padding_bottom'			    => '90',
			'article_search_box_margin_bottom'			    => '0',
