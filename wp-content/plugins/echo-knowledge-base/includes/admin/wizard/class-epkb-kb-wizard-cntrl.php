...
class EPKB_KB_Wizard_Cntrl {
	...
	public function wizard_update_order_view() {
		...
		//Plain Colors
		$new_kb_config['section_head_category_icon_color'] = '#000';
		$new_kb_config['section_head_font_color'] = '#000';
		$new_kb_config['article_font_color'] = '#000';
		$new_kb_config['article_icon_color'] = '#459fed';
		$new_kb_config['section_category_font_color'] = '#000';
		$new_kb_config['section_category_icon_color'] = '#000';
