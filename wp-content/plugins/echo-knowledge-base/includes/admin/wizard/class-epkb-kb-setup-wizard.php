...
class EPKB_KB_Setup_Wizard {
		...
		<div id="epkb-wsb-step-2-panel" class="epkb-setup-wizard-theme epkb-wc-step-panel eckb-wizard-step-2">
			...
			<div class="epkb-setup-wizard-theme-preview">
				...
				<div class="epkb-wizard-theme-tab-container">
					...
					$theme_images = array(
							'Basic Layout'              => array(
									'theme_standard'            => 'setup-wizard/Basic-Layout-Standard.jpg',
									'theme_elegant'             => 'setup-wizard/Basic-Layout-Elegant.jpg',
									'theme_modern'              => 'setup-wizard/Basic-Layout-Modern.jpg',
									'theme_image'               => 'setup-wizard/Basic-Layout-Image.jpg',
									'theme_informative'         => 'setup-wizard/Basic-Layout-Informative.jpg',
									'theme_bright'              => 'setup-wizard/Basic-Layout-Bright.jpg',
									'theme_formal'              => 'setup-wizard/Basic-Layout-Formal.jpg',
									'theme_disctinct'           => 'setup-wizard/Basic-Layout-Distinct.jpg',
									'theme_faqs'                => 'setup-wizard/Basic-Layout-FAQs.jpg',
							),
							'Tabs Layout'               => array(
									'theme_organized'           => 'setup-wizard/Tabs-Layout-Organized.jpg',
									'theme_organized_2'         => 'setup-wizard/Tabs-Layout-Organized-2.jpg',
									'theme_products_style'      => 'setup-wizard/Tabs-Layout-Product-Style.jpg',
									'theme_tabs_clean_style'    => 'setup-wizard/Tabs-Layout-Clean.jpg',
							),
							'Category Focused Layout'   => array(
									'standard_2'                => 'setup-wizard/CategoryFocused-Layout-Standard.jpg',
									'standard_3'                => 'setup-wizard/CategoryFocused-Layout-Icon-Focused.jpg',
									'business'                  => 'setup-wizard/CategoryFocused-Layout-Formal.jpg',
									'business_2'                => 'setup-wizard/CategoryFocused-Layout-Minimalistic.jpg',
							),
							'Grid Layout'               => array(
									'theme_grid_basic'          => 'setup-wizard/Grid-Layout-Basic.jpg',
									'theme_grid_demo_5'         => 'setup-wizard/Grid-Layout-Informative.jpg',
									'theme_grid_demo_6'         => 'setup-wizard/Grid-Layout-Simple.jpg',
									'theme_grid_demo_7'         => 'setup-wizard/Grid-Layout-Left-Icon-Style.jpg',
							),
							'Sidebar Layout'            => array(
									'theme_sidebar_basic'       => 'setup-wizard/Sidebar-Layout-Basic.jpg',
									'theme_sidebar_colapsed'    => 'setup-wizard/Sidebar-Layout-Collapsed.jpg',
									'theme_sidebar_formal'      => 'setup-wizard/Sidebar-Layout-Formal.jpg',
									'theme_sidebar_compact'     => 'setup-wizard/Sidebar-Layout-Compact.jpg',
									'theme_sidebar_plain'       => 'setup-wizard/Sidebar-Layout-Plain.jpg',
							),
					);
								...
								<div id="epkb-setup-wt-theme-<?php echo $template_id; ?>-panel" class="epkb-setup-option-container">
									<div class="epkb-setup-option__inner">
										<div class="epkb-setup-option__featured-img-container">
											<img class="epkb-setup-option__featured-img" src="<?php echo Echo_Knowledge_Base::$plugin_url . 'img/' . $theme_images[$title][$template_id]; ?>" title="<?php echo $template['kb_name']; ?>" />
										</div>
	...
	private function setup_wizard_frontend_editor( $kb_config ) {
	   ...
	   $editor_urls = EPKB_Utilities::get_editor_urls( $kb_config, 'templates' );     ?>
		...
		<div id="epkb-wsb-step-3-panel" class="epkb-setup-wizard-frontend-editor epkb-wc-step-panel eckb-wizard-step-3">
			...
			<div class="epkb-setup-wizard-button-container">
				<div class="epkb-setup-wizard-button-container__inner">
					<a href="<?php echo $editor_urls['main_page_url']; ?>" class="epkb-setup-wizard-button epkb_main_page_link"><?php _e( 'Frontend Editor', 'echo-knowledge-base' ); ?></a>
				</div>
			</div>
		</div>	<?php
	}
	...
	private function get_divided_templates() {
	   ...
	   $templates = EPKB_KB_Wizard_Themes::get_all_presets();
	...
	public function apply_setup_wizard_changes() {
	   ...
	   // get current Add-ons configuration
		...
		if ( EPKB_Icons::is_theme_with_image_icons( $new_config ) ) {
			...
			// update each top-level category
			...
			foreach ( $kb_categories as $kb_category ) {
				...
				// for this theme update sub-categories as well
				if ( $new_config['theme_name'] == 'theme_organized_2' ) {
					$kb_child_categories = EPKB_Categories_DB::get_child_categories($kb_id, $term_id);
					foreach ($kb_child_categories as $kb_child_category) {
						$term_id = $kb_child_category->term_id;
						if (in_array($term_id, $categories_icons_ids)) {
							$categories_icons[$term_id]['type'] = 'image';
							$categories_icons[$term_id]['image_thumbnail_url'] = empty($categories_icons[$term_id]['image_thumbnail_url']) ? Echo_Knowledge_Base::$plugin_url . EPKB_Icons::DEFAULT_IMAGE_SLUG : $categories_icons[$term_id]['image_thumbnail_url'];
						} else {
		...
		$editor_urls = EPKB_Utilities::get_editor_urls( $new_config, 'templates' );

		$message = __('Configuration Saved', 'echo-knowledge-base');
		wp_die( json_encode( array( 'message' => $message, 'kb_main_page_link' => $editor_urls['main_page_url'] ) ) );
	}
